		...
		<?php 
			...
			if($num_rows)
			{
				for($a=1;$a<=$num_rows;$a++)
				{
					...
					echo		"<a href=\"#\"><span class=\"titlespan\">".$title."</span></a>&nbsp;|&nbsp;".getMonth($month)." $year (Vol. ".intval($volume).", Issue&nbsp;".intval($inum).")<br/><a href=\"showAuthorArticles.php?authid=$authorid\"><span class=\"authorspan\">".$authorname."</span> </a>";
					echo	"</div>";
					echo"</div>";
				}
			}
