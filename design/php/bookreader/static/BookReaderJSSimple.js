...
br.getPageURI = function(index, reduce, rotate) {
	...
	{
		$.ajax({type: "POST", url: "../templates/bgconvert.php?level="+level+"&index="+index+"&volume="+book.volume+"&imgurl="+book.imgurl+"&mode="+this.mode+"&month="+book.month+"&year="+book.year, async: true , data : {book:this.book.imglist}});
