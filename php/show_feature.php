...
echo "<div class=\"alphabet\">Feature - $featurename</div><br>";
$query1 = "select * from article where featid=$featureid order by volume,issue,title, page";
...
if($num_rows1)
{
	for($a=1;$a<=$num_rows1;$a++)
	{
		...
		echo "&nbsp;&nbsp;|&nbsp;&nbsp;<span class=\"month_feature\"><a href=\"toc.php?volume=$vnum&amp;issue=$inum\">".$month_eng{intval($month)}."&nbsp;$year";
		echo ",$volume($issue)</a></span>";
		echo "</li>";
        echo "</ul>";
